          ...
          public void onReceive(Context arg0, Intent arg1) 
          {
              switch (getResultCode())
              {
                  case Activity.RESULT_OK:
                      ...
                      Notification notification = new Notification(R.drawable.ic_launcher,"Timer Text Message Sent!", System.currentTimeMillis());
                      intent1.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP| Intent.FLAG_ACTIVITY_CLEAR_TOP);
                      ...
                      notification.flags |= Notification.FLAG_AUTO_CANCEL;
                      notification.setLatestEventInfo(getApplicationContext(), "Timer Text", "Text Sent Successfully", pendingNotificationIntent);
